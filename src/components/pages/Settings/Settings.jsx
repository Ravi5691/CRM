    ...
    <div className="flex flex-col p-10 h-screen bg-[#0f0f0f] text-white">
      ...
      <div className="w-full h-12 rounded-lg my-5 flex justify-between p-1 bg-[#252525]">
        <div
          ...
          onClick={() => handleClick("General Settings", 0)}
        >
          General
        </div>
        <div
          ...
          onClick={() => handleClick("User Management Settings", 1)}
        >
          User Management
        </div>
        <div
          className={`flex w-1/4 justify-center items-center ${
            activeIndex === 2 ? "bg-[#0a0a0a]" : ""
          }`}
          onClick={() => handleClick("Notification Settings", 2)}
        >
          Notifications
        </div>
        <div
          className={`flex w-1/4 justify-center items-center ${
            activeIndex === 3 ? "bg-[#0a0a0a]" : ""
          }`}
          onClick={() => handleClick("Security Settings", 3)}
        >
          Security
        </div>
      </div>
